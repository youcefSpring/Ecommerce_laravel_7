           ...
           <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
               ...
               <li class="nav-item  open ">
                   <a href=""><i class="la la-home"></i>
                       ...
                       <span
                           class="badge badge badge-info badge-pill float-right mr-2">APP</span>
                   </a>
               ...
               <li class="nav-item"><a href=""><i class="la la-group"></i>
                       ...
                       <span
                           class="badge badge badge-success badge-pill float-right mr-2">{{ \App\Models\Category::where('parent_id',NULL)->count() }}</span>
                   </a>
                   <ul class="menu-content">
                       <li class="active">
                        <a class="menu-item" href="{{ route('MainCategoriesList') }}" data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                       </li>
                       <li>
                       <a class="menu-item" href="{{ route('MainCategoriesCreate') }}" data-i18n="nav.dash.crypto">أضافة قسم جديد </a>
                       </li>
                   </ul>
               </li>
               ...
               <li class="nav-item"><a href=""><i class="la la-group"></i>
                       ...
                       <span
                           class="badge badge badge-info badge-pill float-right mr-2">{{ \App\Models\Category::whereNotNull('parent_id')->count() }}</span>
                   </a>
                   <ul class="menu-content">
                       <li class="active"><a class="menu-item" href="{{ route('SubCategoriesList') }}"
                                             data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                       </li>
                       <li><a class="menu-item" href="{{ route('SubCategoriesCreate') }}" data-i18n="nav.dash.crypto">أضافة
                               قسم فرعي جديد </a>
                       </li>
                   </ul>
               </li>
